...
First, we plot koi_score versus koi_disposition. Koi_score showed up first 
```{r}
...
```  
#koi_disp against koi_prad
#koi_prad is the radius of the planet, to see if there is a relationship with the radius and outcome
