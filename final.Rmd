...
#time0bk is the time corresponding to the center of the first detected transit in Barycentric Julian Day 
ggplot(koi, aes(x= koi_disposition, y= koi_time0bk, color = koi_disposition)) + geom_point()
